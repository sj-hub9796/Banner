...
public class BukkitMethodHooks {
    ...
    static {
        try {
            ...
            var fallMethod = FallingBlockEntity.class.getDeclaredMethod("fall", Level.class, BlockPos.class, BlockState.class, CreatureSpawnEvent.SpawnReason.class);
    ...
    public static FallingBlockEntity fall(Level level, BlockPos pos, BlockState blockState, CreatureSpawnEvent.SpawnReason spawnReason) {
        try {
