...
public interface MixinBlockGetter extends InjectionBlockGetter {
    ...
    @Shadow
    @Nullable BlockHitResult clipWithInteractionOverride(Vec3 startVec, Vec3 endVec, BlockPos pos, VoxelShape shape, BlockState state);
    ...
    default BlockHitResult clip(ClipContext raytrace1, BlockPos blockposition) {
        ...
        VoxelShape voxelshape = raytrace1.getBlockShape(iblockdata, ((BlockGetter) this), blockposition);
