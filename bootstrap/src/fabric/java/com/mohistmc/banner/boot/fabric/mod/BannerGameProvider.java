package com.mohistmc.banner.boot.fabric.mod;
...
public class BannerGameProvider extends MinecraftGameProvider {
    ...
    public void initialize(FabricLauncher launcher) {
        ...
        System.setProperty("log4j.configurationFile", "banner-log4j2.xml");
        try {
    ...
    public void unlockClassPath(FabricLauncher launcher) {
        ...
        try {
            ...
            var ctor = launcher.loadIntoTarget("com.mohistmc.banner.fabric.boot.FabricBootstrap").getConstructor();
