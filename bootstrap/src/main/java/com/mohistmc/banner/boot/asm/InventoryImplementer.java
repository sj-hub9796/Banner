package com.mohistmc.banner.boot.asm;
...
public class InventoryImplementer implements Implementer {
    ...
    private static final String BRIDGE_TYPE = "com/mohistmc/banner/common/bridge/core/inventory/IInventoryBridge";
    ...
    private boolean tryImplement(ClassNode node) {
        ...
        if (stackLimitMethod == null) {
            ...
            FieldNode maxStack = new FieldNode(Opcodes.ACC_PRIVATE, "banner$maxStack", Type.getType(Integer.class).getDescriptor(), null, null);
